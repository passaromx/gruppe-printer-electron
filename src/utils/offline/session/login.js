...
module.exports = async (username, password, user, jwt, authenticate) => {
  let config = fs.existsSync(`${dataPath}/config.json`);
  let session = fs.existsSync(`${dataPath}/session.json`);
  if (!config) {
